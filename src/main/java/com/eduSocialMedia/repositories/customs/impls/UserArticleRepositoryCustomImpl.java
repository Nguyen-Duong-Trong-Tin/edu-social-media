...
@Repository
public class UserArticleRepositoryCustomImpl implements UserArticleRepositoryCustom {
  @Override
  public Specification<UserArticleEntity> hasCriteria(UserArticleFindDto query) {
